...
<table style="width:80%;table-layout:fixed; word-break:break-all; height:auto">
    ...
    <tr>
		<td width="20%" align="center" valign="middle"> JPG </td>
        <td width="60%">
			· 파일 확장자 : .jpg <br/>
            · 사진 이미지 저장
		</td>
    ...
    <tr>
		<td width="20%" align="center" valign="middle"> GIF </td>
        <td width="60%">
			· 파일 확장자 : .gif <br/>
            · 애니메이션용
		</td>
    ...
    <tr>
        ...
        <td width="20%" align="center" valign="middle"> src </td>
        <td width="60%">
			· 이미지 파일 경로 + 이미지 이름 <br/>
    ...
    <tr>
		...
		<td width="60%"> 이미지 설명 (브라우저에서의 이미지 이름) </td>
	</tr>
	<tr>
		<td width="20%" align="center" valign="middle"> width </td>
		<td width="60%"> 이미지 너비 </td>
	</tr>
	<tr>
		<td width="20%" align="center" valign="middle"> height </td>
		<td width="60%"> 이미지 높이 </td>
	</tr>
	<tr>
