...
<table style="width:100%;table-layout:fixed; word-break:break-all; height:auto">
    ...
    <tr> 
        <td align="center" valign="middle"> COUNTBLANK </td>
        <td>
    ...
    <tr> 
        <td align="center" valign="middle"> COUNTIF </td>
        <td>
    ...
    <tr> 
        <td align="center" valign="middle"> COUNTIFS </td>
        <td>
...
<table style="width:100%;table-layout:fixed; word-break:break-all; height:auto">
    ...
    <tr>
        <td align="center" valign="middle"> VLOOKUP </td>
        <td>
    ...
    <tr>
        <td align="center" valign="middle"> HLOOKUP </td>
        <td>
